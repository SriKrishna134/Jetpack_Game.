...
function choseCharacter(){
  ...
  if (characterDecision == 1) {
    ...
    document.getElementById("characterchosen").innerHTML = "Your character selected is Zippy.";
  }
  else if (characterDecision == 2) {
    chosenCharacter = "Images/Character1M.png";
    chosenCharacterFlying = "Images/Character1MFlying.png";
        document.getElementById("characterchosen").innerHTML = "Your character selected is Binky.";
  }
  else if (characterDecision == 3) {
    chosenCharacter = "Images/Character1F.png";
    chosenCharacterFlying = "Images/Character1FFlying.png";
    document.getElementById("characterchosen").innerHTML = "Your character selected is Fluff.";
  }
    ...
    document.getElementById("characterchosen").innerHTML = "Your character selected is Gooby.";
  }
    ...
    document.getElementById("characterchosen").innerHTML = "Your character selected is Wiggy."
  }
  else{
